...
export default function PrescriptionMedicineFinder() {
  ...
  const findMedicineName = async () => {
    ...
    try {
      ...
      const response = await fetch("http://localhost:5003/allergicfind", {
        method: "POST",
        body: formData,
      });
          ...
          <header className="flex items-center">
            ...
            <div>
              ...
              <p className="bg-gradient-to-r from-white to-cyan-500 bg-clip-text text-transparent font-poppins">
                Upload the photo of your prescription and know the name of the allergies. If you have these allergies, don't take these medicines.
              </p>
            </div>
          </header>
          ...
          {step === "results" && (
            ...
            >
              <div className="text-left">
                ...
                <button
                  onClick={reset}
                  className="mt6 w-full px-4 py-2 rounded-xl font-semibold border-2 border-cyan-600 bg-gradient-to-r from-[#004f63] to-blue-400 text-white hover:from-cyan-600 hover:to-cyan-700 hover:shadow-md transition-all duration-300 ease-in-out"
                >
                  Try Again
                </button>
              </div>
