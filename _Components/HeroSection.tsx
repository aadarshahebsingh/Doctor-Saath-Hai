    ...
    <div className="relative min-h-screen pt-32 pb-16 px-4 sm:px-6 lg:px-8 flex items-center">
      ...
      <div className="max-w-7xl mx-auto z-10">
        ...
        >
          ...
          >
            {t("A modern multilingual healthcare platform offering features, solutions, and support")}
          </motion.p>
  ...
  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
    ...
    >
      {t("Features we provide")}
          ...
          >
            {[
              { label: t("instant responses"), value: "1'st" },
{ label: t("diagnostic accuracy"), value: "98.5%" },
{ label: t("issues detected"), value: "15K+" },
,
            ].map((stat, index) => (
              <motion.div
                key={index}
