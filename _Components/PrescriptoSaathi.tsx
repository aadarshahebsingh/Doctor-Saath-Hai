              ...
              <div className="text-sm font-sm text-white bg-[#004f63]/30 rounded-xl px-4 py-2 shadow-md border border-[#006994]/40">
                <span
                  className={`transition-all ${
                    step === "upload" ? "text-cyan-300" : "opacity-50"
                  }`}
                >
                  Upload
                </span>
                ...
                <span
                  className={`transition-all ${
                    step === "preview" ? "text-cyan-300" : "opacity-50"
                  }`}
                >
                  Preview
                </span>
                ...
                <span
                  className={`transition-all ${
                    step === "results" ? "text-cyan-300" : "opacity-50"
                  }`}
                >
                  Results
                </span>
            ...
            {step === "results" && (
              ...
              >
                <div className="text-center">
                  <h2 className="text-3xl font-bold mb-4 text-[#004f63]">
                    Extracted Medicines
                  </h2>
